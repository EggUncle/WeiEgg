...
public class ImageUtil {
    ...
    public static String handleImageOnKitKat(Intent data) {
        ...
        if (DocumentsContract.isDocumentUri(MyApplication.getMyContext(), uri)) {
    ...
    private static String getImagePath(Uri uri, String selection) {
        ...
        Cursor cursor = MyApplication.getMyContext().getContentResolver().query(uri, null, selection, null, null);
        if (cursor != null) {
